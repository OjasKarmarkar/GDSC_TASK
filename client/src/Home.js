...
export default function Home() {
    ...
    return (<div className="m-12">
        <div className="flex flex-row justify-between text-3xl font-semibold font-body"> StudentOps
            <button
                className="text-xl text-white p-2 px-8 text-center flex justify-center items-center rounded-md  bg-indigo-600 hover:bg-indigo-700 active:shadow-lg mouse shadow transition ease-in duration-200 focus:outline-none" onClick={create}>
                New
            </button>
        </div>
